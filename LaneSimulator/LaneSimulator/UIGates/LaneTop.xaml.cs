...
namespace LaneSimulator.UIGates
{
    ...
    public partial class LaneTop
    {
        ...
        public void ExecutorD()
        {
            ...
            _sensorTimerHandler.Timer(24600, _1004_S2_TurnOff);
        }
        ...
        public void _1004_S2_TurnOn(object source, ElapsedEventArgs e)
        {
            ...
            _plcCalls.Client.WriteArea(S7Client.S7AreaPE, _plcCalls.DbNumber, PLCTags._1004_S2, _plcCalls.Amount,
                _plcCalls.Wordlen, Buffer);

            Dispatcher.Invoke((Action)(() => { _1004_S2.Fill = new SolidColorBrush(Colors.Red); }));
        }
        ...
        public void ExecutorE()
        {
            ...
            _sensorTimerHandler.Timer(25600, _1102_S1_TurnOff);

            //        _sensorTimerHandler.Timer(23500, _1101_S2_TurnOff);
            _sensorTimerHandler.Timer(26700, _1102_S2_TurnOff);
            //      _sensorTimerHandler.Timer(24500, _1101_S3_TurnOff);

            _sensorTimerHandler.Timer(27700, _1102_S3_TurnOff);
        }
        ...
        public void _1102_S3_TurnOff(object source, ElapsedEventArgs e)
        {
            ...
            _sensorTimerHandler.Timer(650, _1102_S3_TurnOn); 
        }
        ...
        public void ExecutorF()
        {
            ...
            _sensorTimerHandler.Timer(28700, _1602_S1_TurnOff);
            _sensorTimerHandler.Timer(29700, _1602_S2_TurnOff);
            _sensorTimerHandler.Timer(30700, _1602_S3_TurnOff);
        }
        ...
        public void ExecutorG()
        {
            ...
            _sensorTimerHandler.Timer(31700, _1702_S1_TurnOff);

          //  _sensorTimerHandler.Timer(32000, _1701_S2_TurnOff);
            _sensorTimerHandler.Timer(32700, _1702_S2_TurnOff);
        }
