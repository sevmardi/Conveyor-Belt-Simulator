...
namespace LaneSimulator.Utilities.DragDrop
{
    class DragDropHelper
    {
        ...
        private void _adorner_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (_dropTarget != null)
            {
                try
                {
                    ...
                    SSLCanvas gc = (SSLCanvas)_dropTarget;
                    ...
                    {
                        ((SSLCanvas)_dropTarget).Scroller.ScrollToHorizontalOffset(
                            ((SSLCanvas)_dropTarget).Scroller.HorizontalOffset + 10);
                    ...
                    {
                        ((SSLCanvas)_dropTarget).Scroller.ScrollToVerticalOffset(
                            ((SSLCanvas)_dropTarget).Scroller.VerticalOffset - 10);
                    }
        ...
        private void _adorner_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            ((SSLCanvas)_dropTarget).DisableSizeCanvas = false;
            ((SSLCanvas)_dropTarget).Scroller.UpdateLayout();
