...
namespace SSL_WPF.DragDrop
{
    class DragDropHelper
    {
        ...
        private void _adorner_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (_dropTarget != null)
            {
                try
                {
                    ...
                    {
                        ((SSLCanvas)_dropTarget).SSLScroller.ScrollToHorizontalOffset(
                            ((SSLCanvas)_dropTarget).SSLScroller.HorizontalOffset + 10);
        ...
        private void _adorner_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            ((SSLCanvas)_dropTarget).SSLScroller.UpdateLayout();
